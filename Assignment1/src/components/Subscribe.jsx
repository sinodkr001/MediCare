        ...
        <>
           ...
           <div className="container mx-auto px-12 py-12">
                <div className="max-w-full-lg w-full bg-blue-500 text-white p-8 rounded-lg shadow-lg">
                    ...
                    <form className="flex flex-col lg:flex-row items-center bg-white rounded-sm p-2">
                        <input 
                            type="email" 
                            placeholder="Enter your email address" 
                            className="flex-grow lg:px-12 py-2 text-gray-700 rounded-sm focus:outline-none"
                            required/>
                        <button 
                            type="submit" 
